...
figure
subplot(2,1,1);
trend = fit(x,histeq_SNR_vector,'poly2');
plot(histeq_SNR_vector);
hold on
plot(trend,x,histeq_SNR_vector)
...
subplot(2,1,2);
trend = fit(x,histeq_CNR_vector,'poly2');
plot(histeq_CNR_vector)
hold on
plot(trend,x,histeq_CNR_vector)
