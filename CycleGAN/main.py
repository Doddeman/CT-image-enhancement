...
parser.add_argument('--dataset_dir', dest='dataset_dir', default='test', help='path of the dataset')
...
parser.add_argument('--test_dir', dest='test_dir', default='./new_test', help='test sample are saved here')
