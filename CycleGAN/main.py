...
parser.add_argument('--dataset_dir', dest='dataset_dir', default='down', help='path of the dataset')
...
#Change to save RAM?
parser.add_argument('--load_size', dest='load_size', type=int, default=148, help='scale images to this size')
...
parser.add_argument('--test_dir', dest='test_dir', default='./test_down', help='test sample are saved here')
#Hyperparameter
