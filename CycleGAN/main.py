...
parser.add_argument('--dataset_dir', dest='dataset_dir', default='Full_Quality', help='path of the dataset')
...
parser.add_argument('--test_dir', dest='test_dir', default='./test_Full_Quality', help='test sample are saved here')
